...
/**
* @file
* Definition of ArcticEntityOrganizationMigration.
*/

class ArcticContentOrganizationMigration extends DeimsContentOrganizationMigration {

    public function __construct(array $arguments) {
    parent::__construct($arguments);

    // ARC uses a link field for field_person_organization that has a title
    ...
    // below with the prefix.. i.e; arc_content_type_person
    //
